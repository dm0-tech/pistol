...
| [W-0006](entries/w-0006-ladder-through-lattice.md) | The modal ladder is a chosen path through a model-dependent lattice | spec | spec-proved | established / conjectural | checked | D0.3–D0.4; Props 1.6–1.13 |
| [W-0007](entries/w-0007-hegel-lawvere-correspondence.md) | Hegel supplies the preserve/cease problem; Lawvere proposes a categorical model | sourced | source-audited | established / claimed | checked | Track H; W-0001; W-0006 |

## Standing queues

- **Upgrade queue:** no mechanical upgrade is currently due; W-0002 and
  W-0004 now require typed research questions rather than stronger labels.
- **Attack queue:** W-0003 (d = 24 rootless, d = 32 generic-doubling
  countermodels; the exponential/orthogonal-sum bridge); W-0002 (a typed
  relation between non-idempotent ▷ and the open level, if one exists).
